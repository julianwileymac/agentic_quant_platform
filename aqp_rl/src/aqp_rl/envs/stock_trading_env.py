...
onto :mod:`aqp_rl.core` and the runtime can persist trajectories
...
from aqp_rl.envs.base import default_reward, load_bars, pivot_features, safe_array
...
class StockTradingEnv(gym.Env, RLComponent):
    ...
    # :mod:`aqp_rl.core` reward / observation / termination primitives).
    # ------------------------------------------------------------------
