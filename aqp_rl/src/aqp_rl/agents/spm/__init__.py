...
with _contextlib.suppress(Exception):  # pragma: no cover
    from aqp_rl.agents.q_family import (
...
with _contextlib.suppress(Exception):  # pragma: no cover
    from aqp_rl.agents.actor_critic import (
...
with _contextlib.suppress(Exception):  # pragma: no cover
    from aqp_rl.agents.evolutionary import EvolutionStrategyAgent as _EvolutionStrategyAgent

    tag_class(_EvolutionStrategyAgent, "source:stock_prediction_models")

# New SPM-specific agents.
from aqp_rl.agents.spm.agents import (  # noqa: F401  (registers via @register)
    A3CAgent,
