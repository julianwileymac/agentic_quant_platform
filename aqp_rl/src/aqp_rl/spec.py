...
data_pipeline:
  ...
  module_path: aqp_rl.data_pipelines.iceberg
  kwargs:
...
env:
  ...
  module_path: aqp_rl.envs.stock_trading_env
  kwargs:
    start: "2018-01-01"
    end: "2023-06-30"
...
trajectory_store:
  ...
  module_path: aqp_rl.trajectories.iceberg_writer
  kwargs:
    flush_every: 1000
...
:func:`aqp_rl.registry.persist_spec` writes a new
...
class EnsemblerRef(BaseModel):
    """Reference to a :class:`aqp_rl.core.ensembler.BaseEnsembler` build-spec."""
...
class TrajectoryStoreRef(BaseModel):
    """Reference to a :class:`aqp_rl.core.replay.BaseTrajectoryStore` build-spec."""
...
class RewardRef(BaseModel):
    """Reference to a :class:`aqp_rl.core.reward.BaseRewardModel` build-spec."""

    spec: dict[str, Any] | None = None


class ObservationRef(BaseModel):
    """Reference to a :class:`aqp_rl.core.observation.BaseObservationBuilder` build-spec."""

    spec: dict[str, Any] | None = None


class ActionRef(BaseModel):
    """Reference to a :class:`aqp_rl.core.action.BaseActionSpace` build-spec."""

    spec: dict[str, Any] | None = None


class TerminationRef(BaseModel):
    """Reference to a list of :class:`aqp_rl.core.termination.BaseTerminationCondition` specs."""
