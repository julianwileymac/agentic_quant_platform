...
VALUES_PATH="$(dirname "$0")/../../aqp_platform/deployments/kubernetes/observability/kube-prometheus-stack/helm-values.yaml"
...
kubectl apply -k "$(dirname "$0")/../../aqp_platform/deployments/kubernetes/observability/kube-prometheus-stack/"
