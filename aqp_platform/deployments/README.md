...
- Compose: `docker compose -f aqp_platform/deployments/compose/docker-compose.base.yml -f docker-compose.local.yml --env-file aqp_platform/deployments/compose/.env.local up`
- K8s: `kubectl apply -k aqp_platform/deployments/kubernetes/overlays/<env>`
...
- Generation utility: [`aqp_platform/build/scripts/generate_config.py`](../aqp_platform/build/scripts/generate_config.py)
