...
export function ManageStudioRoute(): React.ReactElement {
  ...
  const [confirm, setConfirm] = useState<
    | { kind: "stop" | "restart"; id: string; ns: string | undefined }
    | null
  >(null);

  const namespaceArg = (ns: string | null | undefined): { ns?: string } =>
    ns ? { ns } : {};
      ...
      <ConfirmFrictionDialog
        ...
        onConfirm={async () => {
          ...
          if (confirm.kind === "stop") {
            stopMut.mutate(
              { id: confirm.id, ...namespaceArg(confirm.ns) },
              {
      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <Badge
              variant={isRunning ? "default" : "negative"}
