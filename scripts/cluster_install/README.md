# scripts/cluster_install/ - AQP-owned cluster bootstrap automation
...
run the AQP workload manifests under `deployments/kubernetes/`.
...
bash scripts/cluster_install/install-questdb.sh
bash scripts/cluster_install/install-redpanda-connect.sh
...
bash scripts/cluster_install/install-phoenix.sh
bash scripts/cluster_install/install-spark-operator.sh
bash scripts/cluster_install/install-flink.sh
bash scripts/cluster_install/install-loki.sh
bash scripts/cluster_install/install-redis.sh
```
