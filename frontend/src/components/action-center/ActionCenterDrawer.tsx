 ...
 * gets there.
 *
 * The close affordance is the built-in `DialogPrimitive.Close` X
 * inside `DialogContent` — we deliberately do not render a second
 * custom X in the header so operators only see one close control.
 */
