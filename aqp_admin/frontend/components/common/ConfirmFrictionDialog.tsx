...
/**
 * Confirmation dialog requiring the operator to type a phrase
 * verbatim before the destructive action fires.
 *
 * Ported from `aqp_admin_ui/src/components/common/ConfirmFrictionDialog.tsx`.
 * Mirrors `aqp_client` conventions per `frontend.mdc` so muscle
 * memory transfers between operator surfaces.
 */
