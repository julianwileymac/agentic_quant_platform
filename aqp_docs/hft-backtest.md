...
time. See [aqp_docs/installation.md](installation.md).
...
- [aqp_docs/optimal-control.md](optimal-control.md) — the JAX HJB closed
  forms that ``GLFTMM`` and ``AvellanedaStoikovMM`` consume.
- [aqp_docs/microstructure-toxicity.md](microstructure-toxicity.md) — the
