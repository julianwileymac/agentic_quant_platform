...
[orchestration-refactor-rollout.md](orchestration-refactor-rollout.md).
...
- [orchestration-refactor-rollout.md](orchestration-refactor-rollout.md) — operator runbook + per-flag rollback.
- [multi-agent-patterns.md](multi-agent-patterns.md) — the seven adapter topologies (Phase 7 docs update).
- [data-mcp.md](data-mcp.md) — `data.orchestration.*` and `data.automation.*` tool catalog.
- [agentic-development.md](agentic-development.md) — where `WorkflowSpec` sits in the four-runtime + skill-artifact framework.
