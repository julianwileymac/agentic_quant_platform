...
> Pair with [aqp_docs/erd.md](erd.md) (visual schema) and
> [aqp_docs/domain-model.md](domain-model.md) (narrative).
...
ERD in [aqp_docs/erd.md](erd.md#core--instruments) lists key columns per
subclass.
