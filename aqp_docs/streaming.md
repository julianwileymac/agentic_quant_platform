...
> Doc map: [aqp_docs/index.md](index.md) · Live subscription flow: [aqp_docs/flows.md#5-bonus-live-data-subscription](flows.md#5-bonus-live-data-subscription) · **Admin & UI**: [aqp_docs/streaming-admin.md](streaming-admin.md).
...
> in [aqp_docs/streaming-admin.md](streaming-admin.md). UI lives under
