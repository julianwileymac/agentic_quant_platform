...
> Pair with [aqp_docs/data-dictionary.md](data-dictionary.md) (column-level
> detail) and [aqp_docs/domain-model.md](domain-model.md) (narrative).
...
3. Update [aqp_docs/data-dictionary.md](data-dictionary.md) with the new
   table's columns.
