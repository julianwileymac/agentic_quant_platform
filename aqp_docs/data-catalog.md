...
> Doc map: [aqp_docs/index.md](index.md) · Sequence diagram: [aqp_docs/flows.md#1-generic-file--iceberg-ingestion](flows.md#1-generic-file--iceberg-ingestion).
>
> See also: [aqp_docs/data-layer-unification.md](data-layer-unification.md) for the
> medallion + active-metadata + lineage layer that wraps the catalog;
> [aqp_docs/data-products.md](data-products.md) for entity-centric data products;
> [aqp_docs/data-mcp.md](data-mcp.md) for the agent-facing tool surface;
> [aqp_docs/datasets-catalog.md](datasets-catalog.md) for the Kedro-style
> `BaseDataset` abstraction that types every catalog entry;
> [aqp_docs/data-discovery.md](data-discovery.md) for the active discovery
> browser that shows ingested + uningested entries side-by-side;
> [aqp_docs/metadata-cache.md](metadata-cache.md) for the Redis prefetch
