...
[aqp_docs/auth0-actions.md](auth0-actions.md) for the JS Action bodies
...
Action body in [auth0-actions.md](auth0-actions.md) shows how to
...
1. **`aqp-post-login`** — JIT user upsert + custom claim injection.
   Body in [auth0-actions.md](auth0-actions.md) ("Phase 7 post-login
...
2. **`aqp-idp-group-sync`** — reads external IdP group claims and
   ...
   Body in [auth0-actions.md](auth0-actions.md) ("Phase 6 — IdP
...
3. **`aqp-agent-delegation`** — RFC 8693 minting for delegated
   ...
   [auth0-actions.md](auth0-actions.md) ("Phase 8 — Custom Token
...
- [aqp_docs/auth0-actions.md](auth0-actions.md) — Action bodies + the
  Custom Token Exchange Profile setup.
- [aqp_docs/identity.md](identity.md) — the full identity stack.
- [aqp_docs/multi-tenancy.md](multi-tenancy.md) — Organization →
  EntraTenantLink → User → Membership flow.
- [aqp_docs/credentials.md](credentials.md) — how M2M + BYOK
...
- [AGENTS.md](../AGENTS.md) — hard rules 27, 44, 45, 50, 51, 52-55.
