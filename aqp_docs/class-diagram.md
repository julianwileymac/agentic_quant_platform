...
> Pair with [aqp_docs/erd.md](erd.md) (database schema) and
> [aqp_docs/architecture.md](architecture.md) (system view).
...
alpha). See [aqp_docs/factor-research.md](factor-research.md) for the
authoring guide.
...
See [aqp_docs/backtest-engines.md](backtest-engines.md) for the full
engine matrix, [aqp_docs/paper-trading.md](paper-trading.md) for the
session lifecycle.
...
Walkthrough lives in [aqp_docs/data-catalog.md](data-catalog.md).
...
Walkthrough lives in [aqp_docs/bots.md](bots.md).
