---
title: 'ADR 003 — Auth0 zero-trust two-layer security model'
summary: 'AQP already uses Auth0 for the operator UI via the in-flight `aqp/auth/providers/auth0.py` plugin (AGENTS hard rule 27). Whats missing for the refactor is the second layer: cryptographic JWT validati...'
owner: platform-team
...
- **Supersedes**: None
- **Related**: [ADR 005 — separated control plane](005-separated-control-plane.md), [aqp_docs/identity.md](../../concepts/identity/identity.md), [aqp_docs/auth0-actions.md](../../concepts/identity/auth0-actions.md)
