---
title: 'ADR 005 — Separated `aqp_control_plane/` micro-project'
summary: 'The in-flight `aqp/api/routes/control_plane.py` exposes deploy / destroy / restart / logs endpoints to the Vite Control Plane UI. It already covers the "local k3d" and "rpi_kubernetes" targets and del...'
owner: platform-team
