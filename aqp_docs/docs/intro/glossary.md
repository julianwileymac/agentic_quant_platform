---
title: 'Glossary'
summary: '> See also: [aqp_docs/index.md](../intro/index.md) for the full doc map'
owner: docs-team
...
> See also: [aqp_docs/index.md](../intro/index.md) for the full doc map.
...
- **`SubscriptionDataConfig`** — The data-plane routing key. Combines
  ...
  [aqp_docs/core-types.md](../concepts/platform/core-types.md).
...
- **`Instrument` joined-table inheritance** — `instruments` is the
  ...
  See [aqp_docs/erd.md](../concepts/platform/erd.md) and
...
- **Persistent host warehouse** — `C:/aqp-warehouse` on Windows,
  ...
  staging dir, and ingest audit logs. See [aqp_docs/data-catalog.md](../concepts/data/data-catalog.md).
...
- **`BaseStrategy`** — Abstract strategy contract under
  ...
  `on_bar`, `on_signal`, etc. See [aqp_docs/backtest-engines.md](../concepts/strategy/backtest-engines.md).
...
- **`IBrokerage` / `IDataQueueHandler`** — Lean-style interfaces
  ...
  [aqp_docs/paper-trading.md](../concepts/trading/paper-trading.md).
...
- **`Bot`** — Smallest self-contained, deployable unit on AQP.
  ...
  [aqp_docs/bots.md](../concepts/agentic/bots.md).
