---
title: 'Installation'
summary: '| Extra | Native build | Notes | | --- | --- | --- | | `optimal-control` | None (pure Python) | Ships the JAX HJB / Lucic-Tse stack. CPU-only by default. | | `hft` | Rust + Maturin | Ships the [hftbac...'
owner: docs-team
...
- [aqp_docs/optimal-control.md](../concepts/strategy/optimal-control.md) — HJB primer + AvSt + CJ.
- [aqp_docs/portfolio-options-mm.md](../concepts/strategy/portfolio-options-mm.md) — Lucic-Tse.
- [aqp_docs/hft-backtest.md](../concepts/strategy/hft-backtest.md) — `LobBacktestEngine` walk-through.
- [aqp_docs/local-platform.md](../concepts/platform/local-platform.md) — single-machine deployment.
