---
title: 'Agentic development for AQP'
summary: 'The agentic-coder research literature talks about "skill artifacts", "skill graphs", "Memento-skills", "auditable execution trails", and "MCP control planes" as if they were novel patterns to invent. ...'
owner: agentic-team
...
> manifesto. Doc map: [aqp_docs/index.md](../../intro/index.md) ·
> Workflow: [../WORKFLOW.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/WORKFLOW.md) ·
> Hard rules: [../AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md).
...
| --- | --- | --- | --- |
| [`AgentSpec`](../aqp/agents/spec.py) | [`AgentRuntime`](../aqp/agents/runtime.py) | `agent_spec_versions` | [agents.md](../../concepts/agentic/agents.md) |
| [`BotSpec`](../aqp_bots/spec.py) | [`BotRuntime`](../aqp_bots/runtime.py) | `bot_versions` | [bots.md](../../concepts/agentic/bots.md) |
| [`RLExperimentSpec`](../aqp/rl/spec.py) | [`RLRuntime`](../aqp/rl/runtime.py) | `rl_experiment_versions` | [rl-framework.md](../../concepts/rl/rl-framework.md) |
| [`AnalysisSpec`](../aqp/analysis/spec.py) | [`AnalysisRuntime`](../aqp/analysis/runtime.py) | `analysis_spec_versions` | [analysis-framework.md](../../concepts/strategy/analysis-framework.md) |
| [`WorkflowSpec`](../aqp/agents/orchestration/spec.py) | [`WorkflowRuntime`](../aqp/agents/orchestration/runtime.py) | `workflow_spec_versions` | [workflow-studio.md](../../concepts/agentic/workflow-studio.md) |
...
- **Static channel** — what doesn't change between sessions:
  - [AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md) — 45 hard rules
  - [.cursor/rules/](../.cursor/rules) — glob-scoped rule files
  - [aqp_docs/](../docs) — narrative architecture
...
The
[../WORKFLOW.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/WORKFLOW.md) document has the full plan→act→reflect
...
- All paper sessions halt within one heartbeat and cancel open
  ...
  acknowledgement (per
  [WORKFLOW.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/WORKFLOW.md)#intervention-nodes).
...
The checklist in [CONTRIBUTING.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/CONTRIBUTING.md) is the last
line of defence:
...
- For SLOW-mode work: TDD-loop followed (see
  [WORKFLOW.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/WORKFLOW.md))
...
1. Read [../AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md) — the canonical 45 rules.
2. Read [../WORKFLOW.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/WORKFLOW.md) — the cadence.
