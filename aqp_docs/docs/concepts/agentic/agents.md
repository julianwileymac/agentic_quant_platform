---
title: 'Agents'
summary: '- **AgentSpec** — declarative blueprint (Pydantic). Holds role, system_prompt, tools, model, memory, RAG clauses, guardrails, output_schema, cost / call caps, and annotations. Defined in [aqp/agents/s...'
owner: agentic-team
...
| Team | Specs | Page |
| --- | --- | --- |
| Research | `research.news_miner`, `research.equity`, `research.universe` | [aqp_docs/research-agents.md](../../concepts/agentic/research-agents.md) |
| Selection | `selection.stock_selector` | [aqp_docs/selection-agents.md](../../concepts/agentic/selection-agents.md) |
| Trader | `trader.signal_emitter` | [aqp_docs/trader-agents.md](../../concepts/agentic/trader-agents.md) |
| Analysis | `analysis.step`, `analysis.run`, `analysis.portfolio` (+ reflector) | [aqp_docs/analysis-agents.md](../../concepts/strategy/analysis-agents.md) |
