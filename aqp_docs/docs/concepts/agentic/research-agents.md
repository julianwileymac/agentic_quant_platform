...
summary: '- **First-order** (price / trade / performance) — `bars_daily`, `performance`. - **Second-order** (SEC, ratios, fundamentals) — `sec_filings`, `sec_xbrl`, `financial_ratios`, `earnings_call`, `news_se...'
owner: agentic-team
