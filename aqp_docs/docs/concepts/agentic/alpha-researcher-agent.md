---
title: 'Alpha Researcher agent + symbolic alpha DSL'
summary: '```mermaid flowchart LR User[Researcher: intent] --> Agent[AlphaResearcher\\nconfigs/agents/alpha_researcher.yaml] Agent --> RAG[RAG: alpha_factors + backtest_summaries] Agent --> Output[JSON proposal\\...'
owner: agentic-team
...
- [Hard rule 39 in AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md)
