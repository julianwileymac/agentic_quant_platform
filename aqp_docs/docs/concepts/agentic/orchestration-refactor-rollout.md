---
title: 'Orchestration control plane refactor — rollout runbook'
summary: '| Flag (env var prefix `AQP_`) | Default | Activates | First needed in | | --- | --- | --- | --- | | `ORCHESTRATION_STUDIO_ENABLED` | `false` | `/workflows/*` API surface, Vite studio routes, `Workflo...'
owner: agentic-team
...
[AQP_REFACTOR_MASTER_PROMPT.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_docs/docs/archive/AQP_REFACTOR_MASTER_PROMPT.md) and
