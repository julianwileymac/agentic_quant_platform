---
title: 'Bots'
summary: 'A **Bot** aggregates everything required to research, evaluate, and deploy an algorithmic trading automation:'
owner: agentic-team
...
hard rules from [AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md) (`router_complete`,
