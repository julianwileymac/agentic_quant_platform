---
title: 'RL FinAgent Layered Reflection Adapter (Phase 10)'
summary: '| # | Stage | YAML | Purpose | | --- | --- | --- | --- | | 1 | `low_intelligence` | [`configs/agents/finagent/low_intelligence.yaml`](../configs/agents/finagent/low_intelligence.yaml) | Factual 2-3 se...'
owner: rl-team
