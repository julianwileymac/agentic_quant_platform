---
title: 'RL policy backbones'
summary: '| Class | Source | Use case | | --- | --- | --- | | [`TransformerBackbone`](../aqp/rl/policies/backbones/transformer.py) | Self-attention encoder over the lookback window | Default for medium sequence...'
owner: rl-team
...
- [aqp_docs/agentic-rl.md](../../concepts/rl/agentic-rl.md)
- [Hard rule 37 in AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md)
