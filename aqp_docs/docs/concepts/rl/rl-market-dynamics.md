---
title: 'RL Market Dynamics Modeling (Phase 6)'
summary: 'The market-dynamics framework labels every bar in a price series with a regime ID (default 4 regimes: strong-down / weak-down / sideways / strong-up). The labels feed:'
owner: rl-team
