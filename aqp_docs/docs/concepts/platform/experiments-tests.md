---
title: 'Experiments + Tests umbrella (Phase 1 of the multi-tenant rollout)'
summary: '| Table | Purpose | Key columns | | ----- | ------- | ----------- | | `experiments` | User-driven container; one row per hypothesis / sweep / iteration | `id`, `slug`, `name`, `kind` (`ml`/`rl`/`analy...'
owner: platform-team
...
Hard rule 34 in [`AGENTS.md`](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md): "Every new
...
- The Phase 2 ownership graph projects every experiment +
  ...
  [`aqp_docs/ownership-graph.md`](../../concepts/platform/ownership-graph.md).
...
- The Phase 7 LEAN clone-to-workspace flow optionally creates an
  ...
  [`aqp_docs/strategy-templates.md`](../../concepts/strategy/strategy-templates.md).
