...
summary: 'The Postgres schema has ~110 ORM classes spread across 11 model files under [aqp/persistence/](../aqp/persistence/). One mega-ERD would be unreadable, so this doc breaks the schema into focused diagra...'
owner: platform-team
...
> Pair with [aqp_docs/data-dictionary.md](../../reference/data-dictionary/index.md) (column-level
> detail) and [aqp_docs/domain-model.md](../../concepts/platform/domain-model.md) (narrative).
...
3. Update [aqp_docs/data-dictionary.md](../../reference/data-dictionary/index.md) with the new
   table's columns.
