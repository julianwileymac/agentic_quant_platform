---
title: 'Unified Entity Registry'
summary: '```mermaid flowchart LR Sources["Iceberg datasets<br/>(CFPB, FDA, USPTO,<br/>SEC, GDELT,<br/>FinanceDatabase, ...)"] Extractors["EntityExtractor.run(rows)"] Registry[(EntityRegistry)] Enrichers["Entit...'
owner: platform-team
