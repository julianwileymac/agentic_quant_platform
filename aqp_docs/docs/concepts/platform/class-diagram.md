...
summary: 'Hand-authored mermaid `classDiagram` blocks for the five hierarchies AI coders most often need to navigate. Every diagram cites the canonical file so you can jump from the diagram into the code in one...'
owner: platform-team
...
> Pair with [aqp_docs/erd.md](../../concepts/platform/erd.md) (database schema) and
> [aqp_docs/architecture.md](../../concepts/platform/architecture.md) (system view).
> Doc map: [aqp_docs/index.md](../../intro/index.md).
...
alpha). See [aqp_docs/factor-research.md](../../concepts/strategy/factor-research.md) for the
authoring guide.
...
See [aqp_docs/backtest-engines.md](../../concepts/strategy/backtest-engines.md) for the full
engine matrix, [aqp_docs/paper-trading.md](../../concepts/trading/paper-trading.md) for the
session lifecycle.
...
Walkthrough lives in [aqp_docs/data-catalog.md](../../concepts/data/data-catalog.md).
...
Walkthrough lives in [aqp_docs/bots.md](../../concepts/agentic/bots.md).
