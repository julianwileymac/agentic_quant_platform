---
title: 'Ownership graph (Phase 2 of the multi-tenant rollout)'
summary: '```mermaid flowchart LR subgraph postgres [Postgres canonical] Orgs[organizations] Teams[teams] Users[users] Mem[memberships] Ws[workspaces] Projects[projects] Labs[labs] Exp[experiments] Tests[tests]...'
owner: platform-team
...
Hard rule 33 in [`AGENTS.md`](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md): "All ownership /
...
- [`aqp_docs/data-mcp.md`](../../concepts/data/data-mcp.md) — the MCP catalog the
  ownership tools plug into.
- [`aqp_docs/identity.md`](../../concepts/identity/identity.md) — how the User node populates
  + how lazy provisioning seeds memberships.
- [`aqp_docs/experiments-tests.md`](../../concepts/platform/experiments-tests.md) — the umbrella
