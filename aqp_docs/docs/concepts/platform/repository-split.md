...
summary: 'This document defines the AQP monorepo boundaries while the platform is being split into future repositories. The current goal is isolation by responsibility without breaking imports, deployment manif...'
owner: platform-team
