...
summary: 'The legacy taxonomy treated REITs and depositary receipts as plain ``InstrumentEquity`` rows with a discriminator flag (``is_adr``), and modelled OTC derivatives as opaque blobs. That worked while age...'
owner: platform-team
