---
title: 'Contingency graphs (OCO / OUO / OTO)'
summary: '| Type | Behaviour | | --- | --- | | **OCO** (one cancels other) | When any constituent fills (partial or full), the others are canceled. Canonical use: bracket a position with a take-profit limit + s...'
owner: platform-team
