...
summary: 'AQP 0.3 ports Leans data model into Python with minimal surface area, full backward compatibility, and strict ``dataclass``-only value objects'
owner: platform-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Full `Symbol` class diagram: [aqp_docs/class-diagram.md#1-symbol--core-enums](../../concepts/platform/class-diagram.md#1-symbol--core-enums).
