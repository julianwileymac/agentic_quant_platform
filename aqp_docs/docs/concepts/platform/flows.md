---
title: 'Major Flows'
summary: 'End-to-end sequence and state diagrams for the four flows that human and AI contributors most often need to reason about. Each diagram cites the canonical files; if the diagram and the code disagree, ...'
owner: platform-team
...
> Pair with [aqp_docs/architecture.md](../../concepts/platform/architecture.md) (system view) and
> [aqp_docs/erd.md](../../concepts/platform/erd.md) (data model).
...
[aqp_docs/data-catalog.md](../../concepts/data/data-catalog.md).
