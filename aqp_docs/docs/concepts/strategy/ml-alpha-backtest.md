---
title: '`AlphaBacktestExperiment`'
summary: 'Use `AlphaBacktestExperiment` whenever you want to answer the question *"how does this model perform when its predictions actually drive trades?"*. The standard `Experiment` family computes IC / RMSE ...'
owner: ml-team
...
- [`aqp_docs/ml-framework.md`](../../concepts/strategy/ml-framework.md)
- [`aqp_docs/backtest-engines.md`](../../concepts/strategy/backtest-engines.md)
- [`aqp_docs/ml-testing.md`](../../concepts/strategy/ml-testing.md)
