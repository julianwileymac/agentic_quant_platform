...
summary: 'The analysis layer is AQPs hash-locked, runtime-driven umbrella for every "explore a dataset" workflow — distribution audits, time-series diagnostics, derivatives pricing, portfolio optimisation, reg...'
owner: strategy-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Lab guide: [aqp_docs/analysis-lab.md](../../concepts/strategy/analysis-lab.md) · Flow reference: [aqp_docs/analysis-flows.md](../../concepts/strategy/analysis-flows.md).
...
[aqp_docs/analysis-agents.md](../../concepts/strategy/analysis-agents.md). The two namespaces are
...
4. **Flows never call `litellm.completion` / `OllamaClient` directly.**
   ...
   by the analysis-AGENTS stack ([aqp_docs/analysis-agents.md](../../concepts/strategy/analysis-agents.md)).
...
5. Update the relevant tab in [aqp_docs/analysis-flows.md](../../concepts/strategy/analysis-flows.md).
