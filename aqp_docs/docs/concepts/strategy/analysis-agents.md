...
summary: '| Spec | Module | Purpose | | --- | --- | --- | | `analysis.step` | [aqp/agents/analysis/step_analyst.py](../aqp/agents/analysis/step_analyst.py) | Verdict + improvements for a single agent step. | | ...'
owner: agentic-team
