---
title: 'vectorbt-pro deep integration'
summary: 'vectorbt-pro is the **primary vectorised backtest engine** in AQP. The integration lives under [aqp/backtest/vbtpro/](../aqp/backtest/vbtpro/) and exposes the full vbt-pro surface (signals, orders, op...'
owner: strategy-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Engines overview: [aqp_docs/backtest-engines.md](../../concepts/strategy/backtest-engines.md).
...
[aqp_docs/backtest-engines.md#agent--ml-components](../../concepts/strategy/backtest-engines.md#agent--ml-components).
