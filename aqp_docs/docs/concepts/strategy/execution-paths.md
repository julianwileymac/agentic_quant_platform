---
title: 'Execution paths: WebSocket priority + queue-preserving amendment'
summary: 'The Nautilus issue [#4000](https://github.com/nautechsystems/nautilus_trader/issues/4000) documents the cost of using REST for amendment: most REST `PATCH` endpoints actually implement amendment as ca...'
owner: trading-team
