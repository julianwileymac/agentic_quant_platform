---
title: 'ML library reference'
summary: '| Library | Wrapper(s) | Optional extra | Example config | | --- | --- | --- | --- | | scikit-learn | `SklearnRegressorModel`, `SklearnClassifierModel`, `SklearnPipelineModel`, `SklearnStackingModel`,...'
owner: ml-team
...
See [`aqp_docs/ml-framework.md`](../../concepts/strategy/ml-framework.md) for the full registry +
`Experiment` contract.
