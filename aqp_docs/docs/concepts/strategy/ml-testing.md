---
title: 'Interactive ML testing workbench'
summary: '> The `/ml/test` page lets users validate deployed models with single > rows, batch slices, A/B comparisons, perturbation sweeps, CSV > uploads, and live streaming — all wired through the same > [`Dep...'
owner: ml-team
