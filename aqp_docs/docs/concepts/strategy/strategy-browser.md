---
title: 'Strategy Browser'
summary: 'The Strategy Browser is a dedicated Solara page at `/strategy-browser` that exposes two complementary views of the strategy library:'
owner: strategy-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Strategy lifecycle: [aqp_docs/strategy-lifecycle.md](../../concepts/strategy/strategy-lifecycle.md).
