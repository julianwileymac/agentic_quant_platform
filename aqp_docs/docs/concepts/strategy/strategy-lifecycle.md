...
summary: 'Every strategy in AQP follows the same six-step cycle: **build → save → version → test → paper → live**'
owner: strategy-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Backtest dispatch sequence: [aqp_docs/flows.md#2-backtest-dispatch](../../concepts/platform/flows.md#2-backtest-dispatch).
