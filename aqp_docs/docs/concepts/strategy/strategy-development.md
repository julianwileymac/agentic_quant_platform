---
title: 'Strategy Development (Consolidated `/strategy-development/*`)'
summary: '```mermaid flowchart TB L["StrategyDevLayout"] L --> Composer["/composer"] L --> Sim["/simulation"] L --> Ideate["/ideation"] L --> Single["/single-predict"] L --> Batch["/predict-batch (Iceberg-aware...'
owner: strategy-team
