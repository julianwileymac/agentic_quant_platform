---
title: 'Analysis Lab — interactive analysis builder'
summary: 'Lives at `/analysis/lab` in the AQP webui (Vite frontend). Hybrid surface: dataset-centric tabbed drill-down (primary path) plus an XYFlow Composer (secondary path) for multi-step pipelines'
owner: strategy-team
...
> Backend: [aqp_docs/analysis-framework.md](../../concepts/strategy/analysis-framework.md) · Flow reference: [aqp_docs/analysis-flows.md](../../concepts/strategy/analysis-flows.md).
