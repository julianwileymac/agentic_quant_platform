---
title: 'Lightweight workbench flows'
summary: '| Flow | Purpose | Backend | | --- | --- | --- | | `linear` | Ridge / Lasso / ElasticNet / BayesianRidge with IC + RMSE / MAE | sklearn | | `decomposition` | STL trend / seasonal / residual | statsmod...'
owner: ml-team
