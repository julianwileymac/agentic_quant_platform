---
title: 'rpi Kubernetes Deployment'
summary: '- A kubeconfig that can reach the rpi cluster. - A registry reachable by every rpi node. - Immutable AQP image tag published with:'
owner: infra-team
