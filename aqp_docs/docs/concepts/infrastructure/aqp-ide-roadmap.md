---
title: 'AQP IDE roadmap'
summary: 'The blueprint targets greenfield buyers of a quant PaaS. AQP already has:'
owner: platform-team
...
- AQP's canonical hard rules: [../AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md).
