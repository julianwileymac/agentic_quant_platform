...
summary: '```mermaid flowchart TB Routes["aqp/api/routes<br/>/cluster, /streaming/kafka, /streaming/flink"] Producers[ProducerSupervisor] FinOps["finops_tasks.audit<br/>(grandfathered direct path)"]'
owner: infra-team
