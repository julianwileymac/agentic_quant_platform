---
title: 'AQP IDE'
summary: 'This page is a thin pointer into the in-folder documentation that lives in `aqp_ide/`. The canonical contracts are there'
owner: platform-team
...
| Topic | Path |
| --- | --- |
| Overview + architecture | [../aqp_ide/README.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/README.md) |
| Process + extension architecture | [../aqp_ide/docs/architecture.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/architecture.md) |
| Per-extension reference | [../aqp_ide/docs/extensions.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/extensions.md) |
| Canonical operator entrypoint (`aqp-cli ide`) | [../aqp_ide/docs/cli-entrypoint.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/cli-entrypoint.md) |
| MCP integration (RFC 9728 + RFC 8707) | [../aqp_ide/docs/mcp-integration.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/mcp-integration.md) |
| Research Copilot (chat agent) | [../aqp_ide/docs/research-copilot.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/research-copilot.md) |
| Notebook (Perspective MIME renderer) | [../aqp_ide/docs/notebook.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/notebook.md) |
| Quant widgets (SpecAuthor / RunInspector / BacktestRunner) | [../aqp_ide/docs/quant-widgets.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/quant-widgets.md) |
| Deployment (local / single-pod K8s / Theia Cloud) | [../aqp_ide/docs/deployment.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/deployment.md) |
| Phased roadmap (blueprint → AQP) | [aqp-ide-roadmap.md](../../concepts/infrastructure/aqp-ide-roadmap.md) |

## Hard-rule touchpoints

The AQP IDE most-cited hard rules from [../AGENTS.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/AGENTS.md):
...
Full CLI reference: [../aqp_cli/docs/index.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_cli/docs/index.md).
...
[../aqp_ide/docs/retire-vendored-workspace.md](https://github.com/julianwileymac/agentic_quant_platform/blob/main/aqp_ide/docs/retire-vendored-workspace.md)
