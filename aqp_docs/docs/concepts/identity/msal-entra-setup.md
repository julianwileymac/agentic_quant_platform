---
title: 'Microsoft Entra ID (MSAL) setup'
summary: '1. Sign in to the [Entra admin center](https://entra.microsoft.com). 2. **Identity → Applications → App registrations → New registration**. 3. Name: `Agentic Quant Platform`. 4. Supported account type...'
owner: identity-team
...
4. Set:
   ...
   [aqp_docs/cloud-credentials.md](../../concepts/identity/cloud-credentials.md)).
