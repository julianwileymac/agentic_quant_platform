...
summary: '```mermaid flowchart LR caller["service code"] --> resolver["CredentialResolver.resolve(CredentialKey)"] resolver --> m2m["M2MStore<br/>(priority 10)"] resolver --> vault["HashicorpVaultStore<br/>(pri...'
owner: identity-team
