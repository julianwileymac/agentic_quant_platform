---
title: 'Federated identity layer'
summary: 'The pieces port (with attribution) from `aqp_snippets/inspiration/auth0-server-python-main` (MIT, Copyright Auth0, Inc.) into AQP-native modules'
owner: identity-team
...
[`aqp_docs/auth0-microsoft-federation.md`](../../concepts/identity/auth0-microsoft-federation.md).
