---
title: 'Credentials resolver'
summary: 'The resolver walks an ordered chain of :class:`aqp.credentials.SecretStore` instances and returns the first non-empty hit, falling back to a caller-supplied default. The chain order means a fresh M2M ...'
owner: identity-team
