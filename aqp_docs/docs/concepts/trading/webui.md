---
title: 'webui — Next.js 15 frontend'
summary: 'The `webui/` package is the React/TypeScript replacement for the legacy Solara UI on `:8765`. It runs as a separate Node process on `:3000` and talks to the FastAPI backend on `:8000` over REST + WebS...'
owner: platform-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · API surface: [aqp_docs/architecture.md#system-component-diagram](../../concepts/platform/architecture.md#system-component-diagram).
