...
summary: 'AQPs paper trading engine is a Lean-inspired async runtime that shares 100% of its strategy code with the backtester. Orders from the same `IStrategy` object flow through the **same ledger tables** r...'
owner: trading-team
...
> Doc map: [aqp_docs/index.md](../../intro/index.md) · Session state machine: [aqp_docs/flows.md#4-paper-trading-session](../../concepts/platform/flows.md#4-paper-trading-session).
