---
title: 'Model serving'
summary: '| Backend | Adapter | CLI | Best for | | --- | --- | --- | --- | | MLflow Models | [`MLflowServeDeployment`](../../aqp/mlops/serving/mlflow_serve.py) | `aqp serve mlflow <uri>` | any flavor logged wit...'
owner: ml-team
...
described in [`aqp_docs/docs/how-to/mlops/k8s-deployment.md`](./k8s-deployment.md)
(Phase 5).
