---
title: 'Operations runbook — Secret rotation'
summary: 'Every entry in [`aqp_platform/deployments/compose/.env.schema`](../../aqp_platform/deployments/compose/.env.schema) with `classification: secret` or `classification: rotation-required`. The rotation-r...'
owner: sre-team
