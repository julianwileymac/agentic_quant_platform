---
title: 'Operations runbook — Local setup'
summary: '| Tool | Min version | Used for | | --- | --- | --- | | Python | 3.11 | AQP runtime + the new `aqp_platform_core` + `aqp_control_plane` packages | | Node.js | 20 | Vite + legacy webui builds | | pnpm ...'
owner: sre-team
