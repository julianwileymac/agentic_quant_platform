---
title: 'Operations runbook — Configuration management'
summary: '[`aqp_platform/deployments/compose/.env.schema`](../../aqp_platform/deployments/compose/.env.schema) is the source of truth. Every variable declared anywhere (compose, K8s ConfigMap, K8s Secret, appli...'
owner: sre-team
