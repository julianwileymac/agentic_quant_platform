---
title: 'Tower Two-Node Cluster Deploy'
summary: '- In scope: AQP stack bootstrap (`tower-dev`), QuestDB, control-plane wiring. - Out of scope: `julianwiley-portal` migration (deferred; owned by `rpi_kubernetes`)'
owner: sre-team
