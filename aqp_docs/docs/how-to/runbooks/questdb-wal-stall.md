---
title: 'Runbook — QuestDB WAL apply stall'
summary: '- `questdb_wal_apply_lag_seconds` Prometheus metric is above 60s. - New dbt model materialization runs hang on INSERT. - The QuestDB UI shows `WAL applied = N` is no longer advancing'
owner: sre-team
