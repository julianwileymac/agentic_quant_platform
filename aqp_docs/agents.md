...
| Team | Specs | Page |
| --- | --- | --- |
| Research | `research.news_miner`, `research.equity`, `research.universe` | [aqp_docs/research-agents.md](research-agents.md) |
| Selection | `selection.stock_selector` | [aqp_docs/selection-agents.md](selection-agents.md) |
| Trader | `trader.signal_emitter` | [aqp_docs/trader-agents.md](trader-agents.md) |
| Analysis | `analysis.step`, `analysis.run`, `analysis.portfolio` (+ reflector) | [aqp_docs/analysis-agents.md](analysis-agents.md) |
