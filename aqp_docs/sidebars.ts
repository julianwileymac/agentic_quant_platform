  ...
  architectureSidebar: [
    {
      ...
      collapsed: false,
      items: [
        'architecture/decisions/001-static-export-over-ssr',
        'architecture/decisions/002-single-container-client',
        'architecture/decisions/003-auth0-zero-trust',
        'architecture/decisions/004-provider-abstraction',
        'architecture/decisions/005-separated-control-plane',
        'architecture/decisions/006-quantbot-operator-pattern',
        'architecture/decisions/007-quantbot-latency-classes',
        'architecture/decisions/008-quantbot-event-sourcing',
        'architecture/decisions/009-quantbot-rts6-conformance',
        'architecture/decisions/010-quantbot-canary-pnl-gates',
        'architecture/decisions/010-rl-production-enhancement',
      ],
    },
    {
      type: 'category',
