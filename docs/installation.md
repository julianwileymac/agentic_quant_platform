...
- [docs/optimal-control.md](optimal-control.md) — HJB primer + AvSt + CJ.
- [docs/portfolio-options-mm.md](portfolio-options-mm.md) — Lucic-Tse.
- [docs/hft-backtest.md](hft-backtest.md) — `LobBacktestEngine` walk-through.
- [docs/local-platform.md](local-platform.md) — single-machine deployment.
