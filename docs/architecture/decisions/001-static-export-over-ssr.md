...
- **Supersedes**: None
- **Related**: [ADR 002 — single container client](002-single-container-client.md), [`aqp_client/CUTOVER.md`](../../../aqp_client/CUTOVER.md)
...
- Vite is already canonical per [`aqp_client/CUTOVER.md`](../../../aqp_client/CUTOVER.md). Picking the in-flight stack avoids reopening the cutover debate.
