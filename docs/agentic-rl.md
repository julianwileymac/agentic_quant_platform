...
- [docs/weight-centric-pipeline.md](weight-centric-pipeline.md) —
  Deep dive on `f_S/f_A/f_T/f_R` semantics.
- [docs/rl-policy-backbones.md](rl-policy-backbones.md) —
  Transformer / RNN / Autoencoder / PatchTST backbones.
- [docs/alpha-researcher-agent.md](alpha-researcher-agent.md) —
