...
> Doc map: [docs/index.md](index.md) · Lab guide: [docs/analysis-lab.md](analysis-lab.md) · Flow reference: [docs/analysis-flows.md](analysis-flows.md).
...
[docs/analysis-agents.md](analysis-agents.md). The two namespaces are
...
4. **Flows never call `litellm.completion` / `OllamaClient` directly.**
   ...
   by the analysis-AGENTS stack ([docs/analysis-agents.md](analysis-agents.md)).
...
5. Update the relevant tab in [docs/analysis-flows.md](analysis-flows.md).
