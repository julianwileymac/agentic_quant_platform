...
- [`docs/data-mcp.md`](data-mcp.md) — the MCP catalog the
  ownership tools plug into.
- [`docs/identity.md`](identity.md) — how the User node populates
  + how lazy provisioning seeds memberships.
- [`docs/experiments-tests.md`](experiments-tests.md) — the umbrella
