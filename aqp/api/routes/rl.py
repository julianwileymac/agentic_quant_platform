...
_ENVIRONMENTS: dict[str, dict[str, Any]] = {
    ...
    "finrl_stock_trading": {
        ...
        "module": "aqp.rl.envs.finrl_stock_env",
...
def list_components() -> dict[str, Any]:
    ...
    import aqp.rl  # noqa: F401  pylint: disable=unused-import

    from aqp.rl.core.schemas import list_kinds_with_counts
...
def list_components_of_kind(kind: str) -> dict[str, Any]:
    import aqp.rl  # noqa: F401

    from aqp.rl.core.base import RL_KINDS
    from aqp.rl.core.schemas import list_component_schemas
...
def preview_reward(req: RewardPreviewRequest) -> dict[str, Any]:
    ...
    from aqp.rl.core.reward import BaseRewardModel
...
def preview_action(req: ActionPreviewRequest) -> dict[str, Any]:
    ...
    from aqp.core.registry import build_from_config
    from aqp.rl.core.action import BaseActionSpace
...
def create_spec(req: SpecCreateRequest) -> dict[str, Any]:
    from aqp.rl.registry import add_spec, persist_spec
...
def list_specs() -> dict[str, Any]:
    from aqp.rl.registry import list_rl_specs
...
def run_spec(slug: str, req: SpecRunRequest) -> TaskAccepted:
    ...
    if req.target == "train":
        from aqp.tasks.rl_tasks import train_rl_experiment
        ...
        from aqp.tasks.rl_tasks import evaluate_rl_experiment
        ...
        from aqp.tasks.rl_tasks import replay_trajectories
        ...
        from aqp.tasks.rl_tasks import walk_forward_ensemble
        ...
        from aqp.tasks.rl_tasks import paper_trade_rl
...
def replay_run(run_id: str, req: ReplayRequest) -> TaskAccepted:
    ...
    from aqp.rl.registry import replay_spec_version
    from aqp.tasks.rl_tasks import replay_trajectories
