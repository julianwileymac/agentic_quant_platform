...
"aqp.rl.policies.feature_extractors.BackboneFeaturesExtractor"`` plus
...
:class:`aqp.rl.agents.cleanrl_adapter.CleanRLAdapter` that calls
:func:`aqp.rl.policies.build_backbone_from_alias` directly when
...
from aqp.rl.policies.feature_extractors import (
