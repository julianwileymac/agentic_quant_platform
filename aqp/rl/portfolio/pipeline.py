...
class WeightCentricPipeline:
    ...
    def __init__(
        ...
        *,
        ...
        from aqp.rl.portfolio.allocator import IdentityAllocator
        from aqp.rl.portfolio.risk_overlay import RiskOverlay
        from aqp.rl.portfolio.selector import StaticUniverseSelector
        from aqp.rl.portfolio.timing import ConstantTimingAdjuster
