...
def _emit_document_aspects(
    ...
    try:
        ...
        logger.info("Emitted %d USPTO Document aspects for %s.", len(emitted), corpus_name)
    except Exception:
        logger.exception(
...
def index_uspto_patents(
    *,
    ...
    try:
        ...
        return 0
    _emit_document_aspects(items, corpus_name="uspto_patents")
...
def index_uspto_trademarks(
    *,
    ...
    try:
        ...
        return 0
    _emit_document_aspects(items, corpus_name="uspto_trademarks")
...
def index_uspto_assignments(
    *,
    ...
    try:
        ...
        return 0
    _emit_document_aspects(items, corpus_name="uspto_assignments")
