...
:mod:`aqp_models.models` implements. The contract is deliberately narrow so both
...
class BaseModel(Serializable, ABC):
    ...
    # chain (see :class:`aqp_models.processors.PreprocessingSpec`). ``None`` is
    ...
    def with_preprocessing(self, spec: Any) -> BaseModel:
        """Attach a :class:`aqp_models.processors.PreprocessingSpec` and return
...
class Model(BaseModel, ABC):
    ...
    Subclasses are expected to consume an :class:`aqp_models.dataset.DatasetH`
