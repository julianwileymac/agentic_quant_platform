...
via :mod:`aqp_models.models.spm._torch_base`. See
...
with _contextlib.suppress(Exception):  # pragma: no cover
    from aqp_models.models.spm.forecasters import (  # noqa: F401
...
with _contextlib.suppress(Exception):  # pragma: no cover
    from aqp_models.models.spm.classical import (  # noqa: F401
        ARIMAForecaster,
