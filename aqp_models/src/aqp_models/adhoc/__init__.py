...
>>> from aqp_models.adhoc import quick_ridge, quick_iforest, quick_prophet
...
from aqp_models.adhoc.anomaly import (  # noqa: F401
    quick_ecod,
    quick_iforest,
    quick_lof,
)
from aqp_models.adhoc.embeddings import (  # noqa: F401
    quick_finbert_sentiment,
    quick_text_embed,
)
from aqp_models.adhoc.forecast import (  # noqa: F401
    quick_naive_baseline,
    quick_theta,
)
from aqp_models.adhoc.regression import (  # noqa: F401
    quick_elasticnet,
    quick_panel_fixed_effects,
    quick_ridge,
)
from aqp_models.adhoc.timeseries import (  # noqa: F401
    quick_arima,
    quick_decompose,
    quick_ets,
    quick_prophet,
