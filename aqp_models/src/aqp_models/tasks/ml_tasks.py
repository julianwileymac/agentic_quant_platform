...
requested :class:`aqp_models.base.Model`, runs Record templates (signal /
...
def train_ml_model(
    ...
    try:
        ...
        try:
            from aqp_models.recorder import SignalRecord
...
def evaluate_ml_model(
    ...
    try:
        from aqp.core.registry import build_from_config
        from aqp_models.base import Serializable
        ...
        from aqp_models.recorder import SigAnaRecord, SignalRecord
...
def run_ml_experiment(
    ...
    try:
        ...
        from aqp_models.experiments import (
            AlphaExperiment,
            AnomalyExperiment,
...
def run_alpha_backtest_experiment(
    ...
    *,
    ...
    :class:`aqp_models.alpha_backtest_experiment.AlphaBacktestExperiment`.
    """
    task_id = self.request.id or f"local-{uuid.uuid4().hex[:8]}"
    ...
    try:
        ...
        from aqp_models.alpha_backtest_experiment import AlphaBacktestExperiment
...
def _resolve_training_inputs(
    *,
    ...
    from aqp_models.planning import artifacts_to_segments
    from aqp.persistence.db import get_session
