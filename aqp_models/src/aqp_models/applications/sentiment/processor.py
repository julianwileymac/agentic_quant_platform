...
Plugs into :class:`aqp_models.handler.DataHandlerLP` exactly like the
built-in processors in :mod:`aqp_models.processors`. The processor:
...
from aqp_models.processors import Processor
