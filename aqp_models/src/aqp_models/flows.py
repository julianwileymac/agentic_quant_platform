...
from aqp_models.models._utils import prepare_panel, split_xy
...
def run_linear_flow(
    ...
    *,
    ...
    from aqp_models.models.linear import LinearModel
...
def run_forecast_flow(
    ...
    *,
    ...
    if backend in {"sktime", "naive"}:
        from aqp_models.applications.forecaster.sktime_adapter import SktimeForecaster
        ...
        from aqp_models.adhoc.forecast import quick_theta

        pred = quick_theta(series, horizon=int(horizon)).forecast
    elif backend == "arima":
        from aqp_models.adhoc.timeseries import quick_arima
        ...
        from aqp_models.adhoc.timeseries import quick_ets
        ...
        from aqp_models.applications.forecaster.prophet_adapter import ProphetForecaster
