...
:mod:`aqp_models.applications.sentiment.datasets` or an arbitrary
...
from aqp_models.applications.sentiment.datasets import FINGPT_DATASETS, SentimentDatasetSpec
