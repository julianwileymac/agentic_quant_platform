"""Alpaca bars — incremental append+dedup.

Endpoint: ``GET https://data.alpaca.markets/v2/stocks/{symbol}/bars``
Rate-limit class: ``alpaca.bars``
"""
...
class AlpacaBarsStream(RateLimitedHttpStream):
    """Per-symbol Alpaca bar slice."""

    url_base = "https://data.alpaca.markets"
    primary_key = ["symbol", "t"]
    cursor_field = "t"

    rate_limit_service = "alpaca.bars"
    ...
    def path(self, stream_slice, **_):  # type: ignore[override]
        return f"/v2/stocks/{stream_slice['key']}/bars"
